    ...
    explorer = {
        ...
        modules = {
            quests = {
                ...
                enableQuestTrackerItemButtons = false,
                ...
                objectiveLocationDisplayMode = "area",
            ...
            professions = {
                ...
                showWorldMapNodes = false,
                showMinimapNodes = false,
                showMinimapNodeDirection = false,
                grayFreshNodes = true,
                respawnEstimate = "conservative",
                hideTrivialNodes = true,
    ...
    adventurer = {
        ...
        modules = {
            quests = {
                ...
                objectiveLocationDisplayMode = "area",
                showDistantMinimapQuestMarkers = true,
                showRepeatableQuests = false,
                showReputationQuests = false,
                showAvailableQuests = true,
                showIncompleteDungeonTurnins = false,
    ...
    guide = {
        ...
        modules = {
            quests = {
                ...
                enableQuestTrackerItemButtons = true,
                showMapMarkers = true,
                showQuestObjectiveMarkersInFogOfWar = true,
                showAvailableQuestMarkersInFogOfWar = true,
                showSelectedQuestDirection = true,
                showMinimapObjectiveAreas = true,
                objectiveLocationDisplayMode = "points",
                showDistantMinimapQuestMarkers = true,
                showRepeatableQuests = false,
                showReputationQuests = false,
                showAvailableQuests = true,

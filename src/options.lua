...
local questsPanel = BuildOptionsPanel({
    ...
    options = {
        ...
        {
            name = "VanillaEnhancedOptionsQuestsShowQuestObjectiveMarkersInFogOfWar",
            settingKey = "showQuestObjectiveMarkersInFogOfWar",
            labelKey = "options.quests.showQuestObjectiveMarkersInFogOfWar.label",
            helpKey = "options.quests.showQuestObjectiveMarkersInFogOfWar.help",
        ...
        {
            name = "VanillaEnhancedOptionsQuestsShowAvailableQuestMarkersInFogOfWar",
            settingKey = "showAvailableQuestMarkersInFogOfWar",
            labelKey = "options.quests.showAvailableQuestMarkersInFogOfWar.label",
            helpKey = "options.quests.showAvailableQuestMarkersInFogOfWar.help",

...
local function LocaleData()
    ...
    if locale == "frFR" and VanillaEnhancedQuestMapLocaleDB and VanillaEnhancedQuestMapLocaleDB.frFR then
        return VanillaEnhancedQuestMapLocaleDB.frFR, locale
    end
    return nil, "enUS"
end
...
function QuestMap:GetLocalizedQuestTitle(quest, questId, fallback)
...
function QuestMap:GetLocalizedSourceName(cluster)
...
function QuestMap:GetLocalizedObjective(quest, cluster)
...
function QuestMap:GetLocalizedObjectives(quest, cluster)
...
function QuestMap:GetLocalizedCountText(kind, count)

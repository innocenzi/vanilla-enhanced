...
local STRINGS = {
    enUS = {
        ...
        ["options.quests.showAvailableQuestsOnMinimap.label"] = "Available quests on minimap",
        ["options.quests.showAvailableQuestsOnMinimap.help"] = "Show nearby available quest starters on the minimap.",
    ...
    frFR = {
        ...
        ["options.quests.showAvailableQuestsOnMinimap.label"] = "Quêtes disponibles sur la minicarte",
        ["options.quests.showAvailableQuestsOnMinimap.help"] = "Affiche sur la minicarte les donneurs de quêtes disponibles proches.",

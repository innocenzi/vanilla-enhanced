...
local STRINGS = {
    ...
    frFR = {
        ...
        ["options.quests.showAvailableQuests.label"] = "Quetes disponibles sur la carte",
        ["options.quests.showAvailableQuests.help"] = "Affiche sur la carte du monde les donneurs de quetes que vous pouvez peut-etre accepter.",
        ["options.quests.onlyShowNearbyAvailableQuests.label"] = "Seulement les quêtes proches",
        ["options.quests.onlyShowNearbyAvailableQuests.help"] = "Limite les marqueurs de quetes disponibles aux donneurs situes a environ 1200 metres de vous.",
        ["options.quests.onlyShowAvailableQuestsAroundPlayerLevel.label"] = "Seulement les quetes de mon niveau",
        ["options.quests.onlyShowAvailableQuestsAroundPlayerLevel.help"] = "Limite les marqueurs de quetes disponibles aux quêtes proches de votre niveau.",

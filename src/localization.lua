...
local STRINGS = {
    ...
    frFR = {
        ...
        ["options.bags.sortOrder.help"] = "Choisissez comment les objets sont triés.",
        ...
        ["options.merchants.safeManualSell.help"] = "Limite la vente manuelle à 12 piles. Si désactivé, tous les objets inutiles seront vendus, mais certains ne pourront pas être rachetés.",
        ...
        ["options.merchants.safeAutoSell.help"] = "Limite la vente automatique à 12 piles. Si désactivé, tous les objets inutiles seront vendus automatiquement, mais certains ne pourront pas être rachetés.",
        ...
        ["options.merchants.scrapStrategy.help"] = "Choisissez quels objets comptent comme camelote. Le nettoyage intelligent inclut aussi l'équipement lié inutilisable, les consommables très faibles et l'équipement lié bien inférieur au vôtre.",
